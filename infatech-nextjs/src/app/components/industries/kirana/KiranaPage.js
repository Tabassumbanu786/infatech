// Bootstrap version of KiranaPage (converted from Tailwind)

import Head from 'next/head';
// import CTASection from '../components/CTASection';
// import TemplateGallery from '../components/TemplateGallery';
import { Clock, Store } from 'react-bootstrap-icons';
...
const KiranaPage = () => {
  ...
  return (
    <div className="container-fluid px-0">
      <Head>
        <title>Digital Solutions for Kirana Stores</title>
        <link
      ...
      {/* Hero Section */}
      <section className="py-5 text-center bg-light bg-gradient" style={{ background: 'linear-gradient(to bottom right, #f0fdf4, #dcfce7)' }}>
        <div className="container">
          <div className="mb-4">
            <div className="rounded-circle d-flex align-items-center justify-content-center mx-auto mb-3" style={{ backgroundColor: '#ff3b00', width: '64px', height: '64px' }}>
              <i className="bi bi-shop-window fs-4 text-white"></i>
            </div>
            <h1 className="display-4 fw-bold text-dark">Digital Solutions <span style={{ color: '#ff3b00' }}>for Kirana Stores</span></h1>
              ...
              <div className="col-md-6" key={idx}>
                <div className="p-4 rounded" style={{ backgroundColor: 'rgba(255, 59, 0, 0.1)' }}>
                  ...
                  <p className="text-muted">
                    {title === 'Online Ordering System' && 'Complete e-commerce solution for grocery orders, daily essentials, and home delivery with integrated payment processing and inventory tracking.'}
                    {title === 'Inventory Management' && 'Smart inventory tracking for all products, automated reorder alerts, and real-time stock updates for customers.'}
                    {title === 'Local Delivery Network' && 'Integrated delivery management system with route optimization, delivery tracking, and customer notifications.'}
                    {title === 'Customer Loyalty Program' && 'Digital loyalty cards, reward points system, and personalized offers to keep customers coming back to your store.'}
                  </p>
                </div>
              </div>
            ))}
      ...
      {/* <TemplateGallery industry="Kirana Stores" templates={templates} /> */}

      {/* Interest Form */}
      {/* <section className="py-5 bg-light">
        <div className="container text-center">
          <h2 className="fw-bold mb-3">Be the First to Know</h2>
          <p className="text-muted mb-4">Join our waitlist to get early access to our kirana store solutions and receive exclusive pre-launch pricing.</p>
